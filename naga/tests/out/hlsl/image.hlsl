...
static const uint sampler_reg = 0;
StructuredBuffer<uint> sampler_array : register(t1, space255);
...
static const uint sampler_cmp = 1;
...
float4 texture_sample() : SV_Target0
{
    ...
    float2 tc = (0.5).xx;
    float3 tc3_ = (0.5).xxx;
    float4 _e9 = image_1d.Sample(nagaSamplerArray[sampler_reg], tc.x);
    float4 _e10 = a;
    a = (_e10 + _e9);
    float4 _e14 = image_2d.Sample(nagaSamplerArray[sampler_reg], tc);
    float4 _e15 = a;
    a = (_e15 + _e14);
    float4 _e19 = image_2d.Sample(nagaSamplerArray[sampler_reg], tc, int2(int2(3, 1)));
    float4 _e20 = a;
    a = (_e20 + _e19);
    float4 _e24 = image_2d.SampleLevel(nagaSamplerArray[sampler_reg], tc, 2.3);
    float4 _e25 = a;
    a = (_e25 + _e24);
    float4 _e29 = image_2d.SampleLevel(nagaSamplerArray[sampler_reg], tc, 2.3, int2(int2(3, 1)));
    float4 _e30 = a;
    a = (_e30 + _e29);
    float4 _e35 = image_2d.SampleBias(nagaSamplerArray[sampler_reg], tc, 2.0, int2(int2(3, 1)));
    float4 _e36 = a;
    a = (_e36 + _e35);
    float4 _e41 = image_2d_array.Sample(nagaSamplerArray[sampler_reg], float3(tc, 0u));
    float4 _e42 = a;
    a = (_e42 + _e41);
    float4 _e47 = image_2d_array.Sample(nagaSamplerArray[sampler_reg], float3(tc, 0u), int2(int2(3, 1)));
    float4 _e48 = a;
    a = (_e48 + _e47);
    float4 _e53 = image_2d_array.SampleLevel(nagaSamplerArray[sampler_reg], float3(tc, 0u), 2.3);
    float4 _e54 = a;
    a = (_e54 + _e53);
    float4 _e59 = image_2d_array.SampleLevel(nagaSamplerArray[sampler_reg], float3(tc, 0u), 2.3, int2(int2(3, 1)));
    float4 _e60 = a;
    a = (_e60 + _e59);
    float4 _e66 = image_2d_array.SampleBias(nagaSamplerArray[sampler_reg], float3(tc, 0u), 2.0, int2(int2(3, 1)));
    float4 _e67 = a;
    a = (_e67 + _e66);
    float4 _e72 = image_2d_array.Sample(nagaSamplerArray[sampler_reg], float3(tc, 0));
    float4 _e73 = a;
    a = (_e73 + _e72);
    float4 _e78 = image_2d_array.Sample(nagaSamplerArray[sampler_reg], float3(tc, 0), int2(int2(3, 1)));
    float4 _e79 = a;
    a = (_e79 + _e78);
    float4 _e84 = image_2d_array.SampleLevel(nagaSamplerArray[sampler_reg], float3(tc, 0), 2.3);
    float4 _e85 = a;
    a = (_e85 + _e84);
    float4 _e90 = image_2d_array.SampleLevel(nagaSamplerArray[sampler_reg], float3(tc, 0), 2.3, int2(int2(3, 1)));
    float4 _e91 = a;
    a = (_e91 + _e90);
    float4 _e97 = image_2d_array.SampleBias(nagaSamplerArray[sampler_reg], float3(tc, 0), 2.0, int2(int2(3, 1)));
    float4 _e98 = a;
    a = (_e98 + _e97);
    float4 _e103 = image_cube_array.Sample(nagaSamplerArray[sampler_reg], float4(tc3_, 0u));
    float4 _e104 = a;
    a = (_e104 + _e103);
    float4 _e109 = image_cube_array.SampleLevel(nagaSamplerArray[sampler_reg], float4(tc3_, 0u), 2.3);
    float4 _e110 = a;
    a = (_e110 + _e109);
    float4 _e116 = image_cube_array.SampleBias(nagaSamplerArray[sampler_reg], float4(tc3_, 0u), 2.0);
    float4 _e117 = a;
    a = (_e117 + _e116);
    float4 _e122 = image_cube_array.Sample(nagaSamplerArray[sampler_reg], float4(tc3_, 0));
    float4 _e123 = a;
    a = (_e123 + _e122);
    float4 _e128 = image_cube_array.SampleLevel(nagaSamplerArray[sampler_reg], float4(tc3_, 0), 2.3);
    float4 _e129 = a;
    a = (_e129 + _e128);
    float4 _e135 = image_cube_array.SampleBias(nagaSamplerArray[sampler_reg], float4(tc3_, 0), 2.0);
    float4 _e136 = a;
    a = (_e136 + _e135);
    float4 _e138 = a;
    return _e138;
...
float texture_sample_comparison() : SV_Target0
{
    ...
    float _e8 = image_2d_depth.SampleCmp(nagaComparisonSamplerArray[sampler_cmp], tc_1, 0.5);
    float _e9 = a_1;
    a_1 = (_e9 + _e8);
    float _e14 = image_2d_array_depth.SampleCmp(nagaComparisonSamplerArray[sampler_cmp], float3(tc_1, 0u), 0.5);
    float _e15 = a_1;
    a_1 = (_e15 + _e14);
    float _e20 = image_2d_array_depth.SampleCmp(nagaComparisonSamplerArray[sampler_cmp], float3(tc_1, 0), 0.5);
    float _e21 = a_1;
    a_1 = (_e21 + _e20);
    float _e25 = image_cube_depth.SampleCmp(nagaComparisonSamplerArray[sampler_cmp], tc3_1, 0.5);
    float _e26 = a_1;
    a_1 = (_e26 + _e25);
    float _e30 = image_2d_depth.SampleCmpLevelZero(nagaComparisonSamplerArray[sampler_cmp], tc_1, 0.5);
    float _e31 = a_1;
    a_1 = (_e31 + _e30);
    float _e36 = image_2d_array_depth.SampleCmpLevelZero(nagaComparisonSamplerArray[sampler_cmp], float3(tc_1, 0u), 0.5);
    float _e37 = a_1;
    a_1 = (_e37 + _e36);
    float _e42 = image_2d_array_depth.SampleCmpLevelZero(nagaComparisonSamplerArray[sampler_cmp], float3(tc_1, 0), 0.5);
    float _e43 = a_1;
    a_1 = (_e43 + _e42);
    float _e47 = image_cube_depth.SampleCmpLevelZero(nagaComparisonSamplerArray[sampler_cmp], tc3_1, 0.5);
    float _e48 = a_1;
    a_1 = (_e48 + _e47);
    float _e50 = a_1;
    return _e50;
...
{
    float2 tc_2 = (0.5).xx;
    float4 s2d = image_2d.GatherGreen(nagaSamplerArray[sampler_reg], tc_2);
    float4 s2d_offset = image_2d.GatherAlpha(nagaSamplerArray[sampler_reg], tc_2, int2(int2(3, 1)));
    float4 s2d_depth = image_2d_depth.GatherCmp(nagaComparisonSamplerArray[sampler_cmp], tc_2, 0.5);
    float4 s2d_depth_offset = image_2d_depth.GatherCmp(nagaComparisonSamplerArray[sampler_cmp], tc_2, 0.5, int2(int2(3, 1)));
    uint4 u = image_2d_u32_.Gather(nagaSamplerArray[sampler_reg], tc_2);
    int4 i = image_2d_i32_.Gather(nagaSamplerArray[sampler_reg], tc_2);
...
{
    float2 tc_3 = (0.5).xx;
    float s2d_1 = image_2d_depth.Sample(nagaSamplerArray[sampler_reg], tc_3);
    float4 s2d_gather = image_2d_depth.Gather(nagaSamplerArray[sampler_reg], tc_3);
    float s2d_level = image_2d_depth.SampleLevel(nagaSamplerArray[sampler_reg], tc_3, 1);
